...
<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=700&size=24&duration=2200&pause=700&color=00FFCC&center=true&vCenter=true&width=800&lines=%3E+system%3A+prakash-webdevx.init();%3E+status%3A+ONLINE+%F0%9F%9F%A2;%3E+role%3A+AI+Agent+Developer;%3E+founder%3A+PRTECH.AI;%3E+location%3A+Coimbatore%2C+India" alt="Typing SVG" />

<br/><br/>

<a href="https://github.com/PrakashWebDevX"><img src="https://komarev.com/ghpvc/?username=PrakashWebDevX&label=PROFILE_VIEWS&color=00FFCC&style=for-the-badge&labelColor=0D1117" /></a>
<a href="https://www.linkedin.com/in/prakashrue"><img src="https://img.shields.io/badge/LINKEDIN-CONNECT-0D1117?style=for-the-badge&logo=linkedin&logoColor=0077B5" /></a>
<a href="https://prtech.netlify.app/"><img src="https://img.shields.io/badge/PRTECH.AI-VISIT-0D1117?style=for-the-badge&logo=vercel&logoColor=00FFCC" /></a>
...
education:  B.Tech AI & Data Science, RVS Group of Institutions (2024–2028)
base:       Coimbatore, Tamil Nadu, India 🇮🇳
mode:       100% Remote
mission:    Making the browser — and the backend behind it — genuinely
            intelligent. Autonomous agents that reason, route, and act.
status:     [ open_to_collabs: true, building: daily ]
```
...
| ⚡ | module | description |
|:---:|---|---|
| 🔀 | `tool_router.agent` | Chooses between internal databases, live web search, and APIs |
| 📚 | `rag.pipeline` | URL → chunk → embed → Supabase pgvector, hallucination-resistant retrieval |
| ⚙️ | `llm.orchestrator` | Multi-step chains coordinating GPT-4o, Gemini Vision, Groq/Llama 3.3, Claude |
| 🗄️ | `hybrid_search.core` | Structured SQL + unstructured vector knowledge, queried together |
| 🔗 | `integrations.prod` | Real auth, billing, publishing — Supabase, Razorpay, LinkedIn/X OAuth |
...
<br/>
[repo ↗](https://github.com/PrakashWebDevX/AI-Business-Research-Agent-Backend)
<br/><br/>
...
**`📚 URL-to-VectorDB RAG`**
<br/>
[repo ↗](https://github.com/PrakashWebDevX/url-to-vectordb-rag-pipeline)
<br/><br/>
Full RAG pipeline — scrape, chunk, embed, cosine-search via pgvector.
<br/><sub>`groq/llama3.3` `pgvector`</sub>
...
**`🌌 RP Vision AI`**
<br/>
[rp-vision-ai.vercel.app](https://rp-vision-ai.vercel.app)
<br/><br/>
Flagship Gen-AI suite: text-to-image, background removal, upscaling.
<br/><sub>`react` `rest_apis` `vercel`</sub>
...
**`✍️ CaptionAI`**
<br/>
[live ↗](https://ai-caption-generator-tawny-nu.vercel.app)
<br/><br/>
...
**`🎬 ReelForgeAI`**
<br/>
[live ↗](https://ai-reel-generator-navy.vercel.app)
<br/><br/>
Generates hooks, scripts, scene breakdowns & hashtags for viral reels.
<br/><sub>`llm` `content_gen`</sub>
...
**`🎨 BrandForgeAI`**
<br/>
[live ↗](https://logo-ai-generator-two.vercel.app)
<br/><br/>
...
**`🧩 LeetAI Agent`**
<br/>
[live ↗](https://leetcode-automation-dashboard.vercel.app)
<br/><br/>
...
**`📈 RP Vision SEO`**
<br/>
[rpvisionai.netlify.app](https://rpvisionai.netlify.app)
<br/><br/>
Analyze, optimize, and scale website search rankings.
<br/><sub>`react` `seo_engine`</sub>
...
<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=15&duration=3000&pause=1500&color=8b949e&center=true&vCenter=true&width=600&lines=%3E+%22Any+sufficiently+advanced+technology+is...%22;%3E+%22...indistinguishable+from+magic.%22" alt="quote typing" />
...
<!-- profile-scan.svg (top panel) and Snake Game animation are separate assets — see setup notes below -->
