...
## <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=26&pause=1000&color=00FFCC&center=true&vCenter=true&width=600&lines=Full-Stack+Web+Developer;Generative+AI+Enthusiast;React+%7C+Next.js+%7C+Three.js%3BBuilding+the+Future,+Pixel+by+Pixel" alt="Typing SVG" /></a>
...
| 🌌 | [**AI BUSINESS AGENT**]([(https://github.com/PrakashWebDevX/AI-Business-Research-Agent-Backend)](https://ai-business-research-agent.netlify.app/)) | AI Business Research Agent An autonomous, tool-using AI agent that answers business questions by intelligently routing between an internal SQL database and live web search | `Python`, `LangChain`, `LLM`, `RAG` |
