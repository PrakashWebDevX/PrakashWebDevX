...
| 🌌 | [**AI BUSINESS AGENT**](https://github.com/PrakashWebDevX/AI-Business-Research-Agent-Backend) | AI Business Research Agent An autonomous, tool-using AI agent that answers business questions by intelligently routing between an internal SQL database and live web search | `Python`, `LangChain`, `LLM`, `RAG` |
